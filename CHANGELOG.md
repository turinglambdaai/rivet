...
- Duplicate Request IDs are discarded before payload decoding, preserving the invariant that one outstanding request ID can produce at most one terminal Response/Error.
